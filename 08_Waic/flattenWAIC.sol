...
contract WAIC is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("WAIC LINGJING NFT", "WAIC LINGJING NFT") {
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(from == address(0) || to == address(0), "nft cannot be transfered");
        super._beforeTokenTransfer(from, to, tokenId);
    }
